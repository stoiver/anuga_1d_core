...
PROJECT_MODULE = "anuga_1d"
PROJECT_ROOT_FILES = ['anuga_1d', 'LICENCE.txt', 'setup.py']
SAMPLE_TEST = "anuga_1d/base/tests/test_quantity:test_creation"
SAMPLE_SUBMODULE = "base"
