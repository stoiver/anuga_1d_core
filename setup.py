...
builtins.__ANUGA_1D_SETUP__ = True

#==============================================================================
DISTNAME = 'anuga_1d'
DESCRIPTION = 'A set of python modules for 1d shallow water flow'
with open('README.md') as f:
    LONG_DESCRIPTION = f.read()
MAINTAINER = 'Stephen Roberts'
MAINTAINER_EMAIL = 'stephen.roberts@anu.edu.au'
URL = "http://github.com/stoiver/anuga_1d_core"
LICENSE = 'GPL'
DOWNLOAD_URL = "http://github.com/stoiver/anuga_1d_core"
#===============================================================================
...
class CleanCommand(Clean):
    ...
    def run(self):
        ...
        if os.path.exists('build'):
            shutil.rmtree('build')
        for dirpath, dirnames, filenames in os.walk('anuga_1d'):
...
def setup_package():
    ...
    store_revision_info(destination_path='anuga_1d')
